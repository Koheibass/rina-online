...
const otoNakamaExtra = (
  <div className="mb-4">
    <div className="bg-cream-footer font-bold py-1.5 px-4 rounded-full inline-block mb-2 text-sm">
      他にも例えば…
    </div>
    <p>
      演奏会の感想部屋 / 本番前の控室 / 好きな作曲家や演奏家について語る部屋 / 休憩談話室
      <br />
      <br />
      などもあり、いろんなお話ができます！
      <br />
...
const otoManabiExtra = (
  <div className="text-[13px] lg:text-[18px] text-text-main leading-relaxed mb-4">
    <p>
    ...
    <div className="mt-4">
      <div className="bg-pink-bg text-primary font-bold py-1.5 px-4 rounded-full inline-block mb-2 text-sm">
        今後の展開予定は…
      </div>
      <p>
      ...
      <p className="mt-4 bg-section-bg rounded-xl p-4">
        <span className="font-bold text-primary">早期入会がお得！</span>
        <br />
        今後の展開によって月会費はおそらく値上げすることとなりますが、既存の会員様は値上げ対象にはなりませんので、
        入会時の月会費のままで継続していただくことができます！
      </p>
    </div>
  </div>
);
...
const otoManabiPreamble = (
  <div className="mb-6 font-bold text-center bg-section-bg rounded-xl p-3">
...
export default function HomePage() {
  return (
    <>
      <Header />
      <HeroCarousel />
      <main className="grow bg-main-bg px-4 lg:px-20 py-4 lg:py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <CourseDetail
            ...
            titleJa="おとなかまコース"
            titleEn="Oto-Nakama"
            catchphrase="まずはここから。気軽につながる音楽仲間"
            ...
            priceUnit="/月"
            buttonHref="#join"
            highlightClass="bg-cream-footer text-text-heading"
            popular
          />
          ...
          <CourseDetail
            ...
            priceUnit="/月"
            buttonHref="#join"
            highlightClass="bg-pink-bg text-primary"
          />
